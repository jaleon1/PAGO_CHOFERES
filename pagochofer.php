...
<html lang="en">
  ...
  <body>
    ...
    <div id=main>
        <div class="container">
            <div class="row">
                <div id="div-mant" class="col">
                    <div id="div-mant-titulo">
                    </div>
                    <div id="div-mants">
                    ...
                    <div id="div-mant-inputs">
                        <div id=div-finca>
                            <div class=div-80>
                                ...
                                <div class=div-80>
                                    <div class=div-80-50>
                                        <label for="lbl-cedula-finca" class="lbl-style">Ubicación</label>
                                        <input type="text" id="inp-cedula-finca" name="inp-cedula-finca" class="input-format" value="" required/>
                                    </div>
                            ...
                            <div class=div-20>
                                    ...
                                    <div class=div-20-20>
                                        ...
                                        <input type="button" id="btnmodificarfinca" class="btn" value="Modificar">                                                                  
                                    </div>
                            </div>
                        </div>                        
                    </div>
                </div>
                <div id="div-form" class="col">
